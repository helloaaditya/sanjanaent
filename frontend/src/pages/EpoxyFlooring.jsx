...
const EpoxyFlooring = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Epoxy Flooring in Bangalore | Sanjana Enterprises</title>
        <meta name="description" content="Premium epoxy flooring services in Bangalore for industrial & commercial spaces. Durable, chemical-resistant floors with 15-20 year lifespan. Free quote." />
        <meta name="keywords" content="epoxy flooring bangalore, industrial epoxy flooring, commercial epoxy flooring, chemical resistant epoxy, anti static epoxy flooring" />
