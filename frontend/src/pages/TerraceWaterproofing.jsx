...
import { Thermometer, Shield, CheckCircle, Award, Phone, ArrowRight, Wrench, Eye, Target, Sparkles, Hammer, Home, Sun, MapPin } from 'lucide-react'
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <ScrollAnimation animation="fade-in-up" delay={0}>
              <div className="flex items-center gap-2 text-orange-600 mb-6">
                <MapPin size={20} />
                <h2 className="text-2xl font-black text-gray-900">Terrace Waterproofing Across Bangalore</h2>
              </div>
              <p className="text-gray-600 mb-6">We serve all major areas. Select your locality or find service near you:</p>
              <div className="mb-4">
                <Link to="/terrace-waterproofing-near-me" className="inline-flex items-center gap-2 text-orange-600 font-semibold hover:text-orange-700">
                  <MapPin size={18} />
              ...
              <div className="flex flex-wrap gap-3">
                {BANGALORE_AREAS.map((area) => (
                  <Link
                    key={area.slug}
                    to={`/terrace-waterproofing-${area.slug}-bangalore`}
