...
const PUFlooring = () => {
  ...
  return (
    <>
      <Helmet>
        <title>PU Flooring in Bangalore | Sanjana Enterprises</title>
        <meta name="description" content="Premium polyurethane flooring services in Bangalore for industrial & commercial spaces. Flexible, impact-resistant floors with 15-20 year lifespan. Free quote." />
        ...
        <meta property="og:description" content="High-performance polyurethane flooring for industrial and commercial spaces. Flexible, impact-resistant, and chemical-resistant with 15-20 year lifespan." />
